...
- [概要](#概要)
- [コミットメッセージの形式](#コミットメッセージの形式)
  - [基本フォーマット](#基本フォーマット)
  - [構成要素](#構成要素)
    - [1. Type（必須）](#1-type必須)
    - [2. Scope（任意）](#2-scope任意)
    - [3. Subject（必須）](#3-subject必須)
    - [4. Body（任意）](#4-body任意)
    - [5. Footer（任意）](#5-footer任意)
- [コミットメッセージの例](#コミットメッセージの例)
  - [基本的な例](#基本的な例)
  - [スコープ付きの例](#スコープ付きの例)
  - [破壊的変更を含む例](#破壊的変更を含む例)
  - [複数の変更を含む例](#複数の変更を含む例)
- [コミットのベストプラクティス](#コミットのベストプラクティス)
  - [1. アトミックなコミット](#1-アトミックなコミット)
  - [2. 頻繁なコミット](#2-頻繁なコミット)
  - [3. テストを通してからコミット](#3-テストを通してからコミット)
  - [4. コミット前のセルフレビュー](#4-コミット前のセルフレビュー)
- [プルリクエストのルール](#プルリクエストのルール)
  - [タイトル](#タイトル)
  - [説明](#説明)
- [ブランチ戦略](#ブランチ戦略)
  - [ブランチ命名規則](#ブランチ命名規則)
  - [主要ブランチ](#主要ブランチ)
- [Git フックの活用](#git-フックの活用)
  - [commit-msg フック](#commit-msg-フック)
  - [pre-commit フック](#pre-commit-フック)
- [便利なGitコマンド](#便利なgitコマンド)
  - [よく使うコマンド](#よく使うコマンド)
  - [エイリアス設定例](#エイリアス設定例)
- [参考資料](#参考資料)
- [改訂履歴](#改訂履歴)
